...
::: {#my-collapse .collapse .mt-3}
1.  Use the `maize` dataset to fit the boundary line model for maize yield as function of soil N using the `blqr()` function assigning it mod_3. Use `tau` = 0.99 and `tau` = 0.95, see the implication.
