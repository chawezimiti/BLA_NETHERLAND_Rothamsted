...
::: {#my-collapse .collapse .mt-3}
A link to dataset `cassava` that contains cassava yields and various soil properties is provided below. You can read it into your R session using the following code.
...
1.  Use the `cassava`  dataset to fit the boundary line model for cassava yield and any soil property of your choice using the blqr function assigning it mod_3
:::
<!-- Unlock input + button -->
